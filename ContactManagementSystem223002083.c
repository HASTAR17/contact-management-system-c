/* The `#include <stdio.h>` directive includes the standard input-output library in your C program,
allowing you to use functions like `printf` and `scanf` for input and output operations. */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
